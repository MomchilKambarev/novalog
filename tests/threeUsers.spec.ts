...
test("Check 3 users create nominations with delays", async ({
  request,
}, testInfo) => {
  testInfo.slow();
  // Step 1
  ...
  await test.step("First user creates second nomination", async () => {
    ...
    console.log("After fourth nomination:", {
      purchaseId: purchase.id,
      newQuantity,
  ...
  await test.step("Second user creates second nomination", async () => {
    ...
    console.log("After fifth nomination:", {
      purchaseId: purchase.id,
      newQuantity,
      expectedQuantity: 9875000,
    });
  ...
  await test.step("Third user creates second nomination", async () => {
    ...
    console.log("After sixth nomination:", {
      purchaseId: purchase.id,
      newQuantity,
      expectedQuantity: 9850000,
    });
